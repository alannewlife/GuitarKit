...
static const chord_variant_t C_DEG_I[] = {
    V("C",     "Major", "C E G",     "",       -1, 3, 2, 0, 1, 0,   0, 3, 2, 0, 1, 0, 1),
    V("Cmaj7", "Maj 7", "C E G B",   "",       -1, 3, 2, 0, 0, 0,   0, 3, 2, 0, 0, 0, 1),
    V("C7",    "Dom 7", "C E G Bb",  "",       -1, 3, 2, 3, 1, 0,   0, 3, 2, 4, 1, 0, 1),
};
static const chord_variant_t C_DEG_II[] = {
    V("Dm",    "Minor", "D F A",     "",       -1, -1, 0, 2, 3, 1, 0, 0, 0, 2, 3, 1, 2),
    V("Dm7",   "Min 7", "D F A C",   "",       -1, -1, 0, 2, 1, 1, 0, 0, 0, 2, 1, 1, 2),
    V("D7",    "Dom 7", "D F# A C",  "",       -1, -1, 0, 2, 1, 2, 0, 0, 0, 2, 1, 3, 2),
};
static const chord_variant_t C_DEG_III[] = {
    V("Em",    "Minor", "E G B",     "",        0, 2, 2, 0, 0, 0,   0, 2, 3, 0, 0, 0, 0),
    V("Em7",   "Min 7", "E G B D",   "",        0, 2, 0, 0, 0, 0,   0, 2, 0, 0, 0, 0, 0),
    V("E7",    "Dom 7", "E G# B D",  "",        0, 2, 0, 1, 0, 0,   0, 2, 0, 1, 0, 0, 0),
};
static const chord_variant_t C_DEG_IV[] = {
    V("F",     "Major", "F A C",     "Easy F",  -1, -1, 3, 2, 1, 1, 0, 0, 3, 2, 1, 1, 2),
    V("Fmaj7", "Maj 7", "F A C E",   "",        -1, -1, 3, 2, 1, 0, 0, 0, 3, 2, 1, 0, 2),
    V("F7",    "Dom 7", "F A C Eb",  "Barre",    1, 3, 1, 2, 1, 1,   1, 3, 1, 2, 1, 1, 0),
};
static const chord_variant_t C_DEG_V[] = {
    V("G",     "Major", "G B D",     "",        3, 2, 0, 0, 0, 3,   2, 1, 0, 0, 0, 3, 0),
    V("Gmaj7", "Maj 7", "G B D F#",  "",        3, 2, 0, 0, 0, 2,   2, 1, 0, 0, 0, 3, 0),
    V("G7",    "Dom 7", "G B D F",   "",        3, 2, 0, 0, 0, 1,   2, 1, 0, 0, 0, 1, 0),
};
static const chord_variant_t C_DEG_VI[] = {
    V("Am",    "Minor", "A C E",     "",       -1, 0, 2, 2, 1, 0,   0, 0, 2, 3, 1, 0, 1),
    V("Am7",   "Min 7", "A C E G",   "",       -1, 0, 2, 0, 1, 0,   0, 0, 2, 0, 1, 0, 1),
    V("A7",    "Dom 7", "A C# E G",  "",       -1, 0, 2, 0, 2, 0,   0, 0, 2, 0, 2, 0, 1),
};
static const chord_variant_t C_DEG_VII[] = {
    V("Bdim",  "Dim",   "B D F",     "",           -1, 2, 3, 4, 3, -1, 0, 1, 2, 4, 3, 0, 1),
    V("Bm7b5", "m7b5",  "B D F A",   "Small barre",-1, 2, 3, 2, 3, -1, 0, 1, 3, 1, 3, 0, 1),
};
...
static const chord_variant_t G_DEG_III[] = {
    V("Bm",    "Minor", "B D F#",    "Barre",      -1, 2, 4, 4, 3, 2, 0, 1, 3, 4, 2, 1, 1),
    V("Bm7",   "Min 7", "B D F# A",  "Easy grip",  -1, 2, 0, 2, 0, -1, 0, 1, 0, 1, 0, 0, 1),
    V("B7",    "Dom 7", "B D# F# A", "",           -1, 2, 1, 2, 0, 2, 0, 2, 1, 3, 0, 4, 1),
};
...
static const chord_variant_t G_DEG_V[] = {
    V("D",     "Major", "D F# A",    "",       -1, -1, 0, 2, 3, 2, 0, 0, 0, 1, 3, 2, 2),
    V("Dmaj7", "Maj 7", "D F# A C#", "Small barre",-1, -1, 0, 2, 2, 2, 0, 0, 0, 1, 1, 1, 2),
    V("D7",    "Dom 7", "D F# A C",  "",       -1, -1, 0, 2, 1, 2, 0, 0, 0, 2, 1, 3, 2),
};
...
static const chord_variant_t G_DEG_VII[] = {
    ...
    V("F#dim",   "Dim",  "F# A C", "No low root", -1, -1, -1, 2, 1, 2, 0, 0, 0, 2, 1, 3, 5),
    V("F#m7b5",  "m7b5", "F# A C E", "Small barre", 2, -1, 2, 2, 1, 0, 2, 0, 3, 3, 1, 0, 0),
};
